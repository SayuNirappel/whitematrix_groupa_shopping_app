...
class Dummydb {
  static List<ProductModel> products = [
    ProductModel(
      ...
      category: "Kurta Set",
      imageUrls: [
        "https://static.cilory.com/735139-thickbox_default/light-green-embroidered-muslin-flared-kurti-with-pants.jpg",
        "https://static.cilory.com/735140-thickbox_default/light-green-embroidered-muslin-flared-kurti-with-pants.jpg"
      ],
      rating: 4.2,
      title: 'HOUSE OF KARI',
      subtitle:
