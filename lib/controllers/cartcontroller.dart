...
class CartProvider with ChangeNotifier {
  ...
  Future<void> fetchCartItems(String userId) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Error fetching cart - Status: ${response.statusCode}, Body: ${response.body}');
      }
    } catch (e, stackTrace) {
  ...
  Future<bool> placeOrder({
    ...
    final url = Uri.parse(
        'https://myntacloneappbackend-1.onrender.com/order/place-an-order/$userId');
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        try {
          ...
          print(
              "❌ Failed to place order: ${response.body} (Status: ${response.statusCode})");
        }
        return false;
      }
    } catch (e, stackTrace) {
...
// add to cart
  ...
  Future<List<dynamic>> fetchAllProducts() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final data = jsonDecode(response.body);
        return data[
            "products"]; // Adjust this based on your actual API response
      } else {
  ...
  Future<void> Addressupdate({
    ...
    final url =
        Uri.parse('https://myntacloneappbackend-1.onrender.com/update-profile');
  ...
  Future<List<Map<String, dynamic>>> fetchUserAddresses({
    ...
    final url = Uri.parse(
        'https://myntacloneappbackend-1.onrender.com/View-profile/$userId'); // Use the parameter directly
