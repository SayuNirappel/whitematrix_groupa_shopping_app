...
ProductsResModel? selectedProduct;
  ...
  double calculateOfferPrice({String? selectedSize}) {
    ...
    final variant = selectedSize != null
        ? (selectedProduct!.variants != null && selectedProduct!.variants?.isNotEmpty == true
            ? selectedProduct!.variants!.firstWhere(
                (v) => v.size == selectedSize,
                orElse: () => selectedProduct!.variants!.first,
              )
            : null)
        : (selectedProduct!.variants != null && selectedProduct!.variants!.isNotEmpty
  ...
  String? discountText({String? selectedSize}) {
    ...
    if (discount != null &&
      ...
      if (discount.type != null && discount.type.toString().toLowerCase() == 'flat') {
        return '₹${discount.value} OFF';
      } else if (discount.type != null && discount.type.toString().toLowerCase() == 'percentage') {
        return '${discount.value}% OFF';
      }
    }
    return null;
  ...
  Map<String, dynamic> getPricingInfo(ProductsResModel product, String? selectedSize) {
    ...
    if (discount != null &&
      ...
      if (discount.type != null && discount.type.toString().toLowerCase().contains('percentage')) {
      ...
      } else if (discount.type != null && discount.type.toString().toLowerCase().contains('flat')) {
