...
class Shoppingbag2 extends StatefulWidget {
  ...
  const Shoppingbag2({super.key, required this.userIdddd, required this.BearerToken});
...
class _Shoppingbag2State extends State<Shoppingbag2> {
  ...
  return selectedIndexes
      ...
      .map((index) => cartProvider.cartItems[index]["image"]?.toString() ?? '')
      .toList();
}
...
void initState() {
 ...
 @override
  ...
  double _calculateTotalSavings() {
    ...
    return selectedIndexes.fold(0.0, (sum, index) {
      final item = cartItems[index];
      final originalPrice = (item['originalPrice'] ?? 0.0) * (item['quantity'] ?? 1);
      ...
      Consumer<CartProvider>(
        ...
        value.productiloading?Center(
         ...
         SingleChildScrollView(
          ...
          children: [
            ...
            TextButton(
              onPressed: () => _showChangeAddressSheet(
                ...
                (selectedAddress) {
                  setState(() {
                   this.selectedAddress = Map<String, dynamic>.from(selectedAddress);
              ...
              child: const Text(
                'Change',
                style: TextStyle(
                    fontWeight: FontWeight.bold, color: Color(0xFFFF3D57)),
              ),
            ),
          ],
        ),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Icon(Icons.keyboard_arrow_right, color: Color(0xFFFF3D57), size: 18),
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: List.generate(_logos.length, (index) {
                        return AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            color: _currentIndex == index ? Colors.grey.shade800 : Colors.grey.shade300,
                          ),
                        );
                      }),
                    ),
                  ...
                  child: Row(
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        radius: 8,
                        child: Icon(Icons.percent, color: Colors.white, size: 11),
                      ),
                      SizedBox(width: 8),
                      RichText(
                        text: TextSpan(
                ...
                child: Row(
                  ...
                  selectedIndexes.clear();
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          if (selectedIndexes.isNotEmpty)
                            TextSpan(
                              text: "(₹${_calculateTotalAmount().toInt()})",
                              style: TextStyle(fontSize: 13, color: Color(0xFFFF3D57), fontWeight: FontWeight.bold),
                            ),
                        ],
                      ),
                    ),
                    ...
                    IconButton(
                      ...
                      onPressed: selectedIndexes.isNotEmpty ? () => _showRemoveSelectedItemsSheet(context) : null,
          ...
          width: 94,
          child: Image.network(
            item['image'] ?? '', // Use the image URL directly from the API
            fit: BoxFit.cover,
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      ...
                                      if (selectedIndexes.isEmpty)
                                        IconButton(
                                          ...
                                          onPressed: () {
                                            _showRemoveConfirmationSheet(context, index, item);
                                          },
                                          padding: EdgeInsets.zero,
                                          constraints: const BoxConstraints(),
                                        ),
                                  ...
                                  Text(
                                    item['productTitle'] ?? 'Unknown Title',
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        InkWell(
                                          onTap: () => _showSizeBottomSheet(index, item),
                                          child: Container(
                                        ...
                                        InkWell(
                                          onTap: () => _showQtyBottomSheet(index, item),
                                          child: Container(
                                    ...
                                    children: [
                                      ...
                                      Text.rich(
                                        TextSpan(
                                          ...
                                          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12),
                                          children: [
                                            TextSpan(text: 'return available', style: TextStyle(color: Colors.black38)),
                                          ],
                                        ),
                                      ),
                                    ],
                ...
                onTap: () {
                  if (selectedIndexes.isEmpty) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text("Select at least one item in bag to Apply coupon"),
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Couponscreen(userId: widget.userIdddd, 
                      cartTotal: _calculateTotalAmount() + couponDiscount)),
                    ).then((result) {
                          if (result != null && result is Map && result.containsKey('discount')) {
            setState(() {
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Spacer(),
                      Icon(Icons.keyboard_arrow_right, color: Colors.black, size: 20)
                    ],
                  ),
                ),
              ),
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                couponDiscount = 0.0; // Reset coupon discount
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                              color: Colors.black, fontWeight: FontWeight.bold, fontSize: 13.1),
                        ),
                        Spacer(),
                        Text(
                          "know more",
                          style: TextStyle(
                              color: Colors.red, fontWeight: FontWeight.bold, fontSize: 13.1),
                        ),
                      ],
                    ),
                    Row(
                      children: donationOptions.map((amount) {
                        final isSelected = isDonationChecked && amount == selectedAmount;
                        return Padding(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (selectedIndexes.isNotEmpty) SizedBox(height: 8),
                    if (selectedIndexes.isNotEmpty)
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
        ...
        Text(
          couponDiscount > 0 ? "- ₹${couponDiscount.toInt()}" : "Apply Coupon",
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              SizedBox(width: 4),
                              Text("Know More", style: TextStyle(fontSize: 14, color: Colors.pink)),
                            ],
                          ),
  ...
  onPressed: () {
    ...
    List<Map<String, dynamic>> selectedItems = selectedIndexes
        ...
        .map((index) => {
              "productId": cartItems[index]["productId"] as String,
              "quantity": cartItems[index]["quantity"] ?? 1,
              "variantSKU": cartItems[index]["variantSKU"] as String,
    ...
    if (selectedIndexes.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("Select at least one item in bag to place order"),
          duration: Duration(seconds: 1),
        ),
      );
...
void _showChangeAddressSheet(BuildContext context, String token, String userId, Function(Map<String, dynamic>)? onAddressSelected) {
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            color: Colors.white,
                            border: Border.all(
                              color: isSelected[index] ? Colors.red : Colors.grey.shade200,
                            ),
                            borderRadius: BorderRadius.circular(8),
                          ),
                          child: Row(
                                ...
                                children: [
                                  ...
                                  if (isSelected[index])
                                    ElevatedButton(
                                      onPressed: () {
                                        setState(() {
                                        selectedAddress = Map<String, dynamic>.from(address);
                                        selectedFullNamePincode = '${address['fullName']}, ${address['pincode']}';
                                        selectedLocalityCityState = '${address['locality']}, ${address['city']}, ${address['state']}';
                                      });
  ...
  void _showRemoveConfirmationSheet(BuildContext context, int index, Map<String, dynamic> item) {
    showModalBottomSheet(
      context: context,
      shape: const RoundedRectangleBorder(
                      ...
                      onPressed: () async {
                        ...
                        setState(() {
                          ...
                          selectedIndexes = selectedIndexes
                              .where((i) => i < context.read<CartProvider>().cartItems.length)
                              .map((i) => i > index ? i - 1 : i)
                              .toSet();
                        });
                        Navigator.pop(context);
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.pop(context);
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text("Move to wishlist not implemented")),
                        );
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color(0xFFFF3D57),
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        try {
                          ...
                          await context.read<CartProvider>().removeMultipleCartItems(
                                userId: widget.userIdddd,
                                items: itemsToRemove,
                              );
                  ...
                  Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: " (${item['applicableDiscount']?['value'] ?? 0}% OFF)",
