...
class _ShoppingBagScreenState extends State<ShoppingBagScreen> {
  ...
  double _calculateTotalAmount() {
    double total =
        selectedTotal; // Includes price * quantity for selected items
  ...
  double getItemTotalPrice(int index) {
    final originalPrice =
        double.tryParse(cartItems[index]["price"].toString()) ?? 0;
    final quantity = itemQuantities[index] ?? 1;
                ...
                children: [
                      ...
                      children: [
                          ...
                          text: TextSpan(
                            ...
                            children: [
                              ...
                              if (selectedIndexes.isNotEmpty)
                                TextSpan(
                                  text:
                                      "(₹${(selectedTotal.toInt() + (isDonationChecked ? selectedAmount : 0))})",
                                  style: TextStyle(
                                    fontSize: 13,
                                    color: Color(0xFFFF3D57),
                                    fontWeight: FontWeight.bold,
                        ...
                        IconButton(
                          ...
                          onPressed: selectedIndexes.isNotEmpty
                              ...
                              : null,
                          color:
                              selectedIndexes.isNotEmpty ? null : Colors.grey,
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.cover,
                                    image: AssetImage(
                                        "assets/images/Special-offer-PNG-HD.webp"),
                                  ),
                                ),
                              ),
                              SizedBox(
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.cover,
                                    image: AssetImage(
                                        "assets/images/opened-gift-box-surprise-png.webp"),
                                  ),
                                ),
                              ),
                              SizedBox(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Get a special deal on one of the below products.',
                                    style: TextStyle(
                                        fontSize: 13.3, color: Colors.grey),
                                  )
                                ],
                              )
                            ],
                  ...
                  Container(
                    color: const Color.fromARGB(
                        255, 246, 244, 244), // Light grey background
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            const Color(0xFFFF3D57), // vibrant pink-red
                              ...
                              children: [
                                ...
                                TextButton(
                                  ...
                                  style: TextButton.styleFrom(
                                    foregroundColor:
                                        const Color(0xFFFF3D57), // pink color
                                    padding: EdgeInsets.zero,
  ...
  void _showQtyBottomSheet(int index) {
    int tempQty =
        itemQuantities[index] ?? 1; // Use the current quantity for the item
                    ...
                    onPressed: () {
                      setState(() {
                        itemQuantities[index] =
                            tempQty; // Update the quantity for the specific item
                      });
                      Navigator.pop(context);
                    },
                    child: const Text(
  ...
  void _showRemoveConfirmationSheet(
      BuildContext context, int index, String imagePath) {
    showModalBottomSheet(
      context: context,
      shape: const RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(top: Radius.circular(16)),
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        List<int> indicesToRemove = selectedIndexes.toList()
