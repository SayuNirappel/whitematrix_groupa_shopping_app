...
//                                 child: Row(
//                                   children: [
//                                     Image.asset(Dummydbs().sp[index], fit: BoxFit.cover,
//                                     height: 50,),
//                                     SizedBox(width: 10),
//                                     Column( 
//                                       crossAxisAlignment: CrossAxisAlignment.start,
...
//                                       ClipRRect(
//                                         borderRadius: BorderRadius.circular(10),
//                                         child: widget.selectedItemImages.isNotEmpty &&
//                                             index < widget.selectedItemImages.length
//                                             ? Image.asset(
...
//                               ),
//                               SizedBox(width: 10),
//                               Text("Exchange/Return window closed on Thu,22 jun 2025",
//                                   style: GoogleFonts.roboto(
//                                     fontSize: 12,
//                                     fontWeight: FontWeight.normal,
//                                     color: Colors.black,
