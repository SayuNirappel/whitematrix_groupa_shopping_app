  ...
  final List<Category> dummyCategories = [
    Category(
      ...
      products: [
        Product(
          imageUrl:
              'https://images.unsplash.com/photo-1585079546985-3160e27c1e9b',
          brand: 'Urbano',
          price: '1049',
          originalPrice: '2499',
        ),
        ...
        Product(
          imageUrl:
              'https://images.unsplash.com/photo-1602810316682-9a4506fd2b02',
          brand: 'Dennis Lingo',
          price: '619',
          originalPrice: '1799',
        ),
    ...
    Category(
      ...
      products: [
        Product(
          imageUrl:
              'https://images.unsplash.com/photo-1600180758890-6f77bff829f4',
          brand: 'H&M',
          price: '499',
          originalPrice: '999',
        ),
        Product(
          imageUrl:
              'https://images.unsplash.com/photo-1531473181181-0f94c8ecf4c9',
          brand: 'WROGN',
          price: '549',
          originalPrice: '1299',
        ),
        ...
        Product(
          imageUrl:
              'https://images.unsplash.com/photo-1520974735194-6d8e09849b36',
          brand: 'Peter England',
          price: '899',
          originalPrice: '2599',
        ),
    ...
    Category(
      ...
      products: [
        Product(
          imageUrl:
              'https://images.unsplash.com/photo-1571019613914-85f342c1d4bb',
          brand: 'HIGHLANDER',
          price: '740',
          originalPrice: '1999',
        ),
...
class offersdb with ChangeNotifier {
  static List<Map<String, dynamic>> bankofferList = [
    ...
    },
    {
      ...
      "discount": "Assured up to 500 cashback",
      "bankdetails":
          "on Mobikwik wallet transaction on a min spend of 1500 tca",
    },
    {
      "image1": "assets/images/Bajaj_logo_PNG_(10).png",
